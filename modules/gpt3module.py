from config import CONFUSED_RESPONSE, openai_channels, openai_api_key, rob_id, service_italics_marks, default_italics_mark
...
class GPT3Module(Module):
    ...
    async def gpt3_chat(self, message):
        ...
        self.log.critical(self.class_name, engine=engine, prompt=prompt)
